    ...
    <section className="space-y-4">
      ...
      <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 p-4">
        <div className="mb-2 flex items-center gap-2">
          ...
          <span className="ml-auto rounded-full bg-white px-2 py-0.5 text-[0.75rem] font-medium text-slate-500">
            準備中
          </span>
        </div>
        <p className="text-[0.8125rem] leading-relaxed text-slate-500">
      ...
      <p className="px-1 text-[0.75rem] leading-relaxed text-slate-400">
